...
static NSString * const HDBItemCollectionViewLayoutItemCellKind = @"ItemCell";
NSString * const HDBItemCollectionViewLayoutItemTitleKind = @"ItemTitle";
static NSString * const BHPhotoEmblemKind = @"Emblem";

@interface HDBItemCollectionViewLayout ()
...
@implementation HDBItemCollectionViewLayout
...
- (void)setup
{
//    self.itemInsets = UIEdgeInsetsMake(10.0f, 22.0f, 10.0f, 85.0f);
//    self.itemSize = CGSizeMake(100, 100);
//    self.interItemSpacingY = 0.0;
//    self.numberOfColumns = 2;
//    self.titleHeight = 26.0f;
    
    self.itemInsets = UIEdgeInsetsMake(22.0f, 37.0f, 13.0f, 22.0f);
    self.itemSize = CGSizeMake(85.0f, 85.0f);
    self.interItemSpacingY = 12.0f;
    self.numberOfColumns = 2;
    self.titleHeight = 26.0f;
    self.viewInRect = CGRectZero;
    ...
    for (NSInteger i = 0; i < RotationCount; i++) {
        ...
        CATransform3D transform = CATransform3DMakeRotation(0, 0.0f, 0.0f, 0.0f);
...
- (void)prepareLayout
{
    ...
    for (NSInteger section = 0; section < sectionCount; section++) {
        ...
        for (NSInteger item = 0; item < itemCount; item++) {
            ...
            if (indexPath.item == 0) {
                ...
                [UICollectionViewLayoutAttributes layoutAttributesForSupplementaryViewOfKind:HDBItemCollectionViewLayoutItemTitleKind withIndexPath:indexPath];
    ...
    newLayoutInfo[HDBItemCollectionViewLayoutItemCellKind] = cellLayoutInfo;
    newLayoutInfo[HDBItemCollectionViewLayoutItemTitleKind] = titleLayoutInfo;
...
{
    return self.layoutInfo[HDBItemCollectionViewLayoutItemCellKind][indexPath];
}

- (UICollectionViewLayoutAttributes *)layoutAttributesForSupplementaryViewOfKind:(NSString *)kind
                                                                     atIndexPath:(NSIndexPath *)indexPath
{
    return self.layoutInfo[HDBItemCollectionViewLayoutItemTitleKind][indexPath];
}
...
- (CGRect)frameForAlbumPhotoAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    float width = 0;
    if (CGRectEqualToRect(_viewInRect, CGRectZero)) {
        width = self.collectionView.bounds.size.width;
    }else
        width = _viewInRect.size.width;
    CGFloat spacingX = width -
                        self.itemInsets.left -
                        self.itemInsets.right -
                        (self.numberOfColumns * self.itemSize.width);
//    if (spacingX > _interItemSpacingY) {
//        spacingX = _interItemSpacingY;
//    }
...
- (CGRect)frameForAlbumTitleAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    frame.origin.x -= _itemInsets.left / 2.0;
    frame.size.width += _itemInsets.left;
